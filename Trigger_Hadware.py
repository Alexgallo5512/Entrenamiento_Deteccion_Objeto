...
FILE_NAME = "captura_sin_tapa.jpg"
...
def save_detection(filepath,frame, class_name="Sin_Tapa"):
    """Guarda imagen de detección"""
    try:
        cv2.imwrite(filepath, frame)
        print(f"✅ Detección guardada: {filepath}")
        detection_event.set()
    except Exception as e:
            ...
            # -------- LÓGICA DE DETECCIÓN --------
                ...
                for cls_id in results[0].boxes.cls.tolist():
                    ...
                    if class_name == "Sin_Tapa":
                        ...
                        save_detection(SAVE_PATH,annotated, class_name)
                        detected = True
